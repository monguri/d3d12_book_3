...
void HelloGeometryShaderApp::PrepareTeapot()
{
  ...
  uavDesc.Format = DXGI_FORMAT_UNKNOWN; // Buffer用
  uavDesc.ViewDimension = D3D12_UAV_DIMENSION_BUFFER; // Buffer用
...
void HelloGeometryShaderApp::PrepareComputeResource()
{
  ...
  rootParams[1].InitAsUnorderedAccessView(1); // RWStructuredBuffer用
